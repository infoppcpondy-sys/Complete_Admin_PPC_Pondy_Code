...
>
  ...
  >
    Reset Dates
      ...
      <h2 className="mb-4 mt-5">User All Properties              <button className="btn btn-secondary mb-3" style={{background:"tomato"}} onClick={handlePrint}>
  Print
</button></h2>
  ...
  {statusProperties[property.ppcId] === "delete" ? (
    <div>
      ...
      <div style={{ fontSize: "0.8rem", color: "#666" }}>
        ...
        <br />
        <strong>Date:</strong> {new Date(property.deletionDate).toLocaleString()}
      </div>
    </div>
  ) : (
    <span
