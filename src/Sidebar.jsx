...
const menuItems = [
 ...
 <li className="p-0 mt-2">
    <NavLink to="/dashboard/daily-report" 
  ...
  <li className="p-0 mt-2">
    <NavLink to="/dashboard/detail-daily-report" 
     onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
      <FaUsers />
...
<li className="p-0 mt-2">
    <NavLink to="/dashboard/call-exprience" onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
      <FaUsers />
...
All Views Datas        </NavLink>
  ...
  aria-controls="LeadMenu"
   style={{borderRadius:"5px",  background:"#8BC34A", cursor: "pointer"}}>
      ...
      <li className="p-0 mt-2">
        <NavLink to="/dashboard/ba-loan-lead" onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
...
<li className="p-0 mt-2">
      ...
      <li className="p-0 mt-2">
        <NavLink to="/dashboard/ppcid-statics"
         onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
