...
const PropertyAssistance = ({ existingData }) => {
                ...
                {filteredOptions.map((option, index) => (
                  <li
                    ...
                    onClick={() => {
                      ...
                      if (
                        currentIndex !== -1 &&
                        currentIndex < dropdownFieldOrder.length - 1
                      ) {
    ...
    cityTimeoutRef.current = setTimeout(async () => {
      ...
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API_URL}/cities?search=${input}`,
        );
  ...
  const fetchAreaSuggestions = (input) => {
    ...
    areaTimeoutRef.current = setTimeout(async () => {
      ...
      try {
        const res = await axios.get(
          `${process.env.REACT_APP_API_URL}/areas?search=${input}`,
        );
  ...
  return (
    <div
      className="property-form-container p-1"
      style={{
        overflowY: "auto",
        position: "relative",
        scrollbarWidth: "none",
    ...
    >
      ...
      <h4
        className="form-title mt-3"
        style={{ color: "#2F747F", fontSize: "15px", fontWeight: "bold" }}
      >
        Buyer Assistance
      </h4>
      ...
      <form onSubmit={handleSubmit} className="p-3">
        <div className="row mb-3 justify-content-around">
          <div className="form-group col-5 p-0 m-0">
            <label style={{ width: "100%" }}>
              <label>
                minPrice <span style={{ color: "red" }}>* </span>
              </label>
          ...
          <div className="form-group col-5 p-0 m-0">
            <label style={{ width: "100%" }}>
              <label>
                maxPrice <span style={{ color: "red" }}>* </span>
              </label>
        ...
        <div className="col-12 mb-3">
          <label style={{ fontWeight: 600 }}>Buyer Name</label>
          <div
            className="input-card p-0 rounded-1"
            style={{
              display: "flex",
